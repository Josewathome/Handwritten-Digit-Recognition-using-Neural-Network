# -*- coding: utf-8 -*-
""" ## tHIS CODE  Launces GUI for writing digits the image of the digits is stored in the same directory after converting it to gray scale and reducing the size to (28 x 28) pixels """
...
window = Tk()
window.title("Handwritten Digits Recognition")
l1 = Label()
...
def MyProject():
    ...
    # Image is captured from canvas and is resized to (28 x 28)pixels
